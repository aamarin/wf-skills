...
allowed-tools: Read Write Bash(date*) Bash(git status*) Bash(git log*) Bash(git diff*) Bash(git symbolic-ref*) Bash(wfctl end*) Bash(wfctl status*) Bash(wfctl state-dir*) Bash(wfctl issue view*)
---
